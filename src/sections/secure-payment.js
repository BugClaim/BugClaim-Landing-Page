...
const data = {
  subTitle: 'PRIVATE PROGRAMS',
  title: 'Securely list out the private programs',
  description:
    'Get your tests delivered without disclosing your assets to public from the victory of the specific verified security researchers that have reported most promising reports ever. Get your security reports in one click and save yourself from future hack.',
  btnName: 'Learn More',
  btnURL: '#',
};
