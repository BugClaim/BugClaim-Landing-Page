...
const data = {
  subTitle: 'Why Bugclaim',
  title: 'All is about FAME whether you are company or researcher',
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      altText: 'Smart Features',
      title: 'Get a CLAIM to save your FAME',
      text:
        'Choose bugclaim to save your fame in the future hacks which are may be left out due to security loopholes.',
    },
    {
      id: 2,
      imgSrc: Secure,
      altText: 'Secure Contents',
      title: 'Make a CLAIM to get your FAME',
      text:
        'Try Bugclaim for reporting bugs to companies and get your name in their Hall of FAME and may be bug bounties.',
    },
  ],
};
